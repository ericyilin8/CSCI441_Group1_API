...
router.post('/register', async (req, res) => {
  try {
    const { username, password, email, phoneNumber, firstName, lastName, avatar } = req.body;
    ...
    const user = new User({ username, password: hashedPassword, email, phoneNumber, firstName, lastName, avatar });
    await user.save();
